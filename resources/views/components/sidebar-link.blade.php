...
$active = request()->is(ltrim($href, '/') . '*') ? 'active' : '';
@endphp
<a href="{{ $href }}" class="sidebar-link {{ $active }} flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-50 hover:text-slate-800 transition-all text-sm font-medium">
